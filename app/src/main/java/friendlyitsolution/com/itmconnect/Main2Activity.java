...
import static friendlyitsolution.com.itmconnect.home.getmeonline;

public class Main2Activity extends AppCompatActivity {
    ListView contact,lv2;
    List<String> name,chatname,frdnum;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        frdnum=new ArrayList<>();
        fdb = FirebaseDatabase.getInstance();
        myref = fdb.getReference("user");
        myref1=fdb.getReference("user").child(Myapp.myphone).child("friend");
        ...
        contact.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                myhome.getmeonline();
                TextView tv=(TextView)view;
                String uid=frdnum.get(i);
                //Toast.makeText(getApplicationContext(),"Cick : "+uid,Toast.LENGTH_LONG).show();//""+main.get(tv.getText().toString());
                createChat(Myapp.myphone,uid,tv.getText().toString());
        ...
        myref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (int i = 0; i < listofname.size(); i++) {
                    ...
                    if(!listofname.get(i).equals(Myapp.myphone)) {
                        name.add(user.get("name") + "( sem " + user.get("sem") + ")");
                        frdnum.add(listofname.get(i));
