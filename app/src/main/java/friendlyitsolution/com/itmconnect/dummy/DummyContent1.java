package friendlyitsolution.com.itmconnect.dummy;
...
public class DummyContent1 {
     ...
     */
    public static final List<DummyItem1> ITEMS = new ArrayList<DummyItem1>();

    /**
     * A map of sample (dummy) items, by ID.
     */
    public static final Map<String, DummyItem1> ITEM_MAP = new HashMap<String, DummyItem1>();
